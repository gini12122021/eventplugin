...
class WP_Event_Manager_Shortcodes {
			...
			try {
				...
				switch ( $action ) {
					...
					case 'delete':
						...
						if ( ! in_array( $events_status, array( 'trash' ) ) ) {
							// Message
	...
	public function edit_event() {
		...
		} elseif ( isset( $_REQUEST['venue_id'] ) && ! empty( $_REQUEST['venue_id'] ) ) {
	...
	public function organizer_dashboard( $atts ) {
		...
		// ....If not show the event dashboard
		$args = apply_filters(
			'event_manager_get_dashboard_organizers_args',
			array(
		...
		$organizer_dashboard_columns = apply_filters(
			'event_manager_organizer_dashboard_columns',
			array(
	...
	public function venue_dashboard( $atts ) {
		...
		// ....If not show the event dashboard
		$args = apply_filters(
			'event_manager_get_dashboard_venue_args',
			array(
		...
		$venue_dashboard_columns = apply_filters(
			'event_manager_venue_dashboard_columns',
			array(
